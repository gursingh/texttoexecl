...
public class LabConverter {
	private static final String BASE_PATH = Consts.LAB_FILE_BASE;
	...
	public static void main(String arg[]) {
		String errorFileName = Consts.LAB_ERROR_FILE;
		Response response = readTextFile(errorFileName);
		String excelFileName = Consts.LAB_INPUT_FILE;
